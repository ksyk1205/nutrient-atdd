...
public class SupplementDocumentationFixture {
    ...
    public static final Page<SupplementsResponse> SEARCH_BY_PAGE_RESPONSE;
    public static final Pageable page;

    private static final int PAGE = 0;
    private static final int PAGE_SIZE = 10;
    public static final List<SupplementsResponse> SUPPLEMENTS_RESPONSES;
    ...
    static {
        ...
        SUPPLEMENTS_RESPONSES = List.of(
            SupplementsResponse.of(
                Supplement.builder()
                    .id(UUID.randomUUID())
                    .title(new SupplementTitle("김화란 클로렐라"))
                    .content(new SupplementContent("20040020014500",
            ...
            SupplementsResponse.of(
                Supplement.builder()
                    .id(UUID.randomUUID())
                    .title(new SupplementTitle("뉴트리코어 클로렐라"))
                    .content(new SupplementContent("20040020014500",
                        LocalDate.of(2010, 8, 13),
                        "제조일로부터 24개월",
                        "1일 1회, 1회 1포를 물 또는 우유에 타서 섭취하십시오.",
            ...
            SupplementsResponse.of(
                Supplement.builder()
                    .id(UUID.randomUUID())
                    .title(new SupplementTitle("나우푸드 클로렐라"))
                    .content(new SupplementContent("20040020014500",
                        LocalDate.of(2010, 8, 13),
                        "제조일로부터 24개월",
                        "1일 1회, 1회 1포를 물 또는 우유에 타서 섭취하십시오.",
        ...
        SEARCH_BY_PAGE_RESPONSE = new PageImpl<>(SUPPLEMENTS_RESPONSES, page,
            SUPPLEMENTS_RESPONSES.size());
    }
